...
try:
    ...
    N = 59      #inp.J point in phase diagram
    txt_S = '30'
    K = 49      #number ok cuts in BZ
    txt_DM = '104'  #DM angle from list
except:
...
Nx = K;     Ny = K
#Filenames
DirName = '/home/darior/Desktop/git/SpinLiquids/Data/S'+txt_S+'/phi'+txt_DM+"/"
DataDir = DirName + str(Nx) + '/'
ReferenceDir = '/home/darior/Desktop/git/SpinLiquids/Data/S'+txt_S+'/phi209/49/'
...
for ans in ansatze:
    ...
    DataDic = {}
    #Actual minimization
    print("Initial point: ",Pinitial[ans])
    result = d_e(cf.Sigma,
        args = Args,
        x0 = Pinitial[ans],
        bounds = Bnds[ans],
