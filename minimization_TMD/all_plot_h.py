...
Color = {'3x3': ['red','coral'],
         'q0':  ['blue','lightskyblue'],
         'cb1':  ['darkgreen','forestgreen'],
         #'cb1_nc':  ['yellow','y'],
         #'labels':  ['k','k']
         }
S_l = ['50','36','34','30','20']
title_Sl = {'50':r'$S=0.5$','36':r'$S=\frac{\sqrt{3}-1}{2}$','34':r'$S=0.34$','30':r'$S=0.3$','20':r'$S=0.2$'}
#S_l = ['50','36','30','20']
DM_l = ['005']
list_plots = []
for s in S_l:
...
fit_classical = np.load("../classical_kagome/phase_diagram/fit_005_151.npy")
