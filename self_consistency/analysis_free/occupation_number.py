...
argv = sys.argv[1:]
try:
    opts, args = getopt.getopt(argv, "S:K:a:", ['j2=','j3=','DM='])
    txt_S = '50'
    phi_t = '000'
    K = '13'
    ans = '15'
...
#        print(J2,J3)
        ...
        for i in range(N):
            ...
            for index_m in range(mm):
                n2_i, n_i, fluc = fs.compute_fluc(data,head,index_m,S,phi,int(K))
#                print(index_m,n2_i,n_i,n_i**2,fluc)
                Res[ans][ind_J//Jpts,ind_J%Jpts,index_m] = n_i#fluc
#            input()
            break
        for index_m in range(mm):
