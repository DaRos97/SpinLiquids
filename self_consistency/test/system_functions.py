...
def find_lists(J2,J3,csvfile,csvref,K,numb_it):
    if K == 13:
        ansatze = ['19']#,'20','15','17','18']#inp.ansatze_1+inp.ansatze_2
        ...
        if my_file.is_file():
            ...
            for i in range(N):
                ...
                if temp_E < minE:
                    ...
                    ansatze[0] = data[0]
    if J2:
        list_p = {'15':[(1,1),], '16':[(0,0),], '20':[(1,1),], '17':[(1,1),], '19':[(1,),], '18':[(0,0),]}
        if J3:
            list_p = {'15':[(1,1),], '16':[(0,0),], '20':[(1,1,0,0),], '17':[(1,1),], '19':[(1,0,0),], '18':[(0,0),]}
    elif J3:
