...
import os
import random
def find_lists(J1,J2,J3,csvfile,csvref,K,numb_it):
    if K == 13:
    ...
    if J1 > 0:
        ...
        if J2:
            list_p = {'15':[(1,1),], '16':[(0,0),], '20':[(0,0),], '17':[(1,1),], '19':[(0,0),], '18':[(0,0),], '14':[(0,0),]}
            if J3:
                list_p = {'15':[(1,1),], '16':[(0,0),], '20':[(0,0,1,0),], '17':[(1,1),], '19':[(0,0,1,0),], '18':[(0,0),], '14':[(0,0),]}
        elif J3:
            list_p = {'15':[(2,2),], '16':[(2,2),], '20':[(1,0),], '17':[(2,2),], '19':[(1,0),], '18':[(2,2),], '14':[(2,2),]}
        else:
            list_p = {'15':[(2,2),], '16':[(2,2),], '20':[(2,2),], '17':[(2,2),], '19':[(2,2),], '18':[(2,2),], '14':[(2,2),]}
